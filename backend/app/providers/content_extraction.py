...
class FirecrawlContentExtractionProvider:
    def __init__(self, api_key: str, endpoint: str = "https://api.firecrawl.dev/v1/scrape", timeout: float = 30.0) -> None:
...
class JinaReaderContentExtractionProvider:
    def __init__(self, endpoint_prefix: str = "https://r.jina.ai/http://", timeout: float = 30.0) -> None:
