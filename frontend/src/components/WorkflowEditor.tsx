...
const PERSONAL_DEFINITION: WorkflowDefinition = {
  ...
  nodes: [
    ...
    { id: "specialist_react_loop", label: "L0-L5 分层 ReAct", node_type: "agent", group: "analysis", status: "pending", reason: "各层 specialist 读取 ContextPack，调用工具、观察结果、更新状态并判断局部覆盖。", details: {} },
  ...
  edges: [
    ...
    { id: "e5", source: "source_collection", target: "specialist_react_loop", label: "分层执行" },
    { id: "e6", source: "specialist_react_loop", target: "evidence_ledger", label: "结构化记忆" },
    { id: "e7", source: "evidence_ledger", target: "coverage_evaluation", label: "覆盖检查" },
    { id: "e8", source: "coverage_evaluation", target: "master_agent", label: "缺口补搜 / 降级决策" },
    { id: "e9", source: "coverage_evaluation", target: "knowledge_structuring", label: "允许建库" },
    { id: "e10", source: "knowledge_structuring", target: "document_writing" },
    { id: "e11", source: "document_writing", target: "artifact_review" },
    { id: "e12", source: "artifact_review", target: "export" },
  ],
};
