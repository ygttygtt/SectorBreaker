...
- V1.3 active planning direction is `Talent Demand Intelligence Agent`, documented at `docs/superpowers/plans/2026-07-04-v1-3-talent-demand-intelligence.md`. Treat it as additive: do not break the default V1.2 domain-knowledge path. The plan prioritizes uploaded JD/report evidence, multi-source search/provider reuse, skill normalization, Source Coverage Matrix, and talent-demand Obsidian export.
